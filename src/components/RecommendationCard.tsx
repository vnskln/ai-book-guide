...
export function RecommendationCard({ recommendation, isCompact = false }: RecommendationCardProps) {
  ...
  return (
    <Card
      className={cn(
        "w-full",
        isCompact && "hover:shadow-md transition-shadow duration-200",
        ...
        {!isCompact && (
          <>
            <div>
              ...
              <p className="text-gray-600 whitespace-pre-wrap">{plot_summary}</p>
            </div>
            <div>
              <h3 className="font-semibold mb-2">Why This Book?</h3>
              <p className="text-gray-600 whitespace-pre-wrap">{rationale}</p>
            </div>
          </>
        )}
